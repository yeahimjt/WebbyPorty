...
const Nav = () => {
  ...
  return (
    <>
      ...
      <nav className={theme==="light"?" shadow-2xl rounded-full fixed font-paragraph text-sm top-2 m-2 mobile:m-4 bg-[color:var(--black-lightest)] text-white border-2 right-2 flex gap-6 px-8 py-3 items-center justify-center mobile:w-[500px] select-none z-50 animate-slidedown animation-delay-2000 opacity-0":"rounded-full fixed font-paragraph text-sm top-2 right-2 m-2  mobile:m-4 bg-[color:var(--white-lightest)] text-black border-2 flex gap-6 px-8 py-3 items-center justify-center mobile:w-[500px] select-none z-50 animate-slidedown animation-delay-2000 opacity-0"}>
          {theme === "light" &&
