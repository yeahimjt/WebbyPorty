...
const Homepage = () => {
  ...
  return (
    ...
    <div className={theme === "light" ? "h-[90vh] bg-white flex justify-center flex-col items-center gap-6 w-full border-b-4 border-black/20" : "h-[90vh] bg-[color:var(--black)] flex justify-center flex-col items-center gap-6 w-full border-b-4 border-black/20"}>
        ...
        <div className={theme==="light"?"flex gap-6 flex-wrap relative top-0 py-8 animate-grow animation-delay-2000 opacity-0 text-black":"flex gap-6 flex-wrap relative top-0 py-8 animate-grow animation-delay-2000 opacity-0 text-white"}>
          <div className="text-center  shadow-lg w-[350px] p-8 rounded-3xl h-[250px] flex justify-center flex-col items-center ">
