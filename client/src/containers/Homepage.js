  ...
  return (
    ...
    <div className={theme === "light" ? " tablet:h-[95vh] bg-white flex justify-center flex-col items-center gap-6 w-full border-b-4 border-black/20 overflow-visible pb-32 z-20" : " tablet:h-[95vh] bg-[color:var(--black)] flex justify-center flex-col items-center gap-6 w-full border-b-4 border-black/20 overflow-visible pb-32 z-20"}>
        ...
        <div className="flex gap-6 smallest:py-4 px-4 overflow-visible z-40">
            ...
            <a href="https://www.linkedin.com" className={theme==="light" ? "bg-[color:var(--black-darkest)] overflow-visible text-white  p-2 rounded-full hover:cursor-pointer hover:scale-105   animate-grow opacity-0 animation-delay-1500 hover:rounded-2xl transition-all" : "bg-[color:var(--white-lightest)] p-2 rounded-full hover:cursor-pointer hover:scale-105 transition-all text-[color:var(--black-darkest)] animate-grow opacity-0 animation-delay-1500 hover:rounded-2xl"}><AiFillLinkedin size={36}/></a>
