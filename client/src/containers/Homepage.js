  ...
  return (
    ...
    <div className={theme === "light" ? "  bg-white flex justify-center flex-col items-center gap-6 w-full border-b-4 border-black/20 overflow-visible pb-64 z-20" : "  bg-[color:var(--black)] flex justify-center flex-col items-center gap-6 w-full border-b-4 border-black/20 overflow-visible pb-64 z-20"} id="">
        ...
        <div className={theme==="light"?"text-center  shadow-lg w-[70%] bg-gray-200/40 backdrop-blur-xl mx-auto tablet:m-0   tablet:w-[350px] p-8 rounded-3xl overflow-visible tablet:h-[250px] flex justify-center flex-col items-center": "text-center  shadow-lg w-[70%] bg-black/10 backdrop-blur-xl mx-auto tablet:m-0   tablet:w-[350px] p-8 rounded-3xl overflow-visible tablet:h-[250px] flex justify-center flex-col items-center"}>
          ...
          <div className={theme==="light"?"text-center  shadow-lg w-[70%] bg-gray-200/40 backdrop-blur-xl mx-auto tablet:m-0   tablet:w-[350px] p-8 rounded-3xl verflow-visible tablet:h-[250px] flex justify-center flex-col items-center": "text-center  shadow-lg w-[70%] bg-black/10 backdrop-blur-xl mx-auto tablet:m-0   tablet:w-[350px] p-8 rounded-3xl overflow-visible tablet:h-[250px] flex justify-center flex-col items-center"}>
            <div className="flex justify-center">
