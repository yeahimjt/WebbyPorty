  ...
  return (
    ...
    <header className=" w-screen relative overflow-visible">
        ...
        <div className="absolute w-full h-[90vh] z-20 ">
          <img className="absolute tablet:-top-8 tablet:left-96   top-24 left-52 animate-cloudMove animate-delay-300 w-[250px] tablet:w-max" src="/c1.png" alt="flying animation"/>
          <img className="absolute tablet:top-24 tablet:left-16   top-32 left-16  animate-move fill-mode-both w-[200px] tablet:w-max" src="/flying.png" alt="flying animation"/>
          <img className="absolute tablet:top-64 top-52  animate-cloudMove2 animate-delay-600 w-[200px] tablet:w-max" src="/c2.png" alt="flying animation"/>
        </div>
      <div className="flex justify-center    ">
        <SkillTease />
    </div>
    <div className={theme === "light" ? " tablet:h-[95vh] bg-white flex justify-center flex-col items-center gap-6 w-full border-b-4 border-black/20 overflow-visible pb-32 z-20" : " tablet:h-[95vh] bg-[color:var(--black)] flex justify-center flex-col items-center gap-6 w-full border-b-4 border-black/20 overflow-visible pb-32 z-20"}>
        <div className={theme==="light" ? "leading-tight bg-white/90 p-4 rounded-2xl z-40 relative text-[color:var(--black-darkest)] select-none mx-8 homepage-text:mx-0 animate-slideup   overflow-visible mt-96 smallest:mt-64" : "leading-tight bg-black/40 rounded-2xl  relative text-[color:var(--white-lightest)] select-none z-40 mx-8 homepage-text:mx-0 animate-slideup overflow-visible mt-96 smallest:mt-64 p-4"}>
        ...
        <div className="flex gap-6 smallest:py-4 px-4 overflow-visible z-40">
            <a href="https://www.github.com" className={theme==="light" ? "bg-[color:var(--black-darkest)] overflow-visible text-white p-2 rounded-full hover:cursor-pointer hover:scale-105  hover:bg-[color:var(--light-blue)] animate-slideright animation-delay-2000 opacity-0 transition-all" : "bg-[color:var(--white-lightest)] p-2 rounded-full hover:cursor-pointer hover:scale-105 transition-all text-[color:var(--black-darkest)] hover:bg-[color:var(--light-blue)] animate-slideright animation-delay-2000 opacity-0"} title="Github Profile"><AiFillGithub size={36}/></a>
            <a href="https://www.linkedin.com" className={theme==="light" ? "bg-[color:var(--black-darkest)] overflow-visible text-white  p-2 rounded-full hover:cursor-pointer hover:scale-105   animate-grow opacity-0 animation-delay-1500 hover:bg-[color:var(--light-blue)] transition-all" : "bg-[color:var(--white-lightest)] p-2 rounded-full hover:cursor-pointer hover:scale-105 transition-all text-[color:var(--black-darkest)] animate-grow opacity-0 animation-delay-1500 hover:bg-[color:var(--light-blue)]"} title="LinkedIn Profile"><AiFillLinkedin size={36}/></a>
            <a href="https://www.resume.com" className={theme==="light" ? "bg-[color:var(--black-darkest)] overflow-visible text-white  p-2 rounded-full hover:cursor-pointer hover:scale-105   animate-slideleft animation-delay-2000 opacity-0 hover:bg-[color:var(--light-blue)] transition-all" : "bg-[color:var(--white-lightest)] p-2 rounded-full hover:cursor-pointer hover:scale-105 transition-all text-[color:var(--black-darkest)] hover:bg-[color:var(--light-blue)] animate-slideleft animation-delay-2000 opacity-0"} title="Resume"><AiFillFilePdf size={36}/></a>
        </div>
        <div className={theme==="light"?"flex  flex-col tablet:flex-row gap-6  relative top-0 py-8 animate-grow animation-delay-2000 opacity-0 justify-center text-black w-full  overflow-visible":"flex flex-col tablet:flex-row gap-6 flex-wrap relative top-0 py-8 animate-grow animation-delay-2000 opacity-0 text-white w-full justify-center overflow-visible"}>
