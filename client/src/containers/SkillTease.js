...
const SkillTease = () => {
  ...
  return (
    <div className={theme==="light"? "max-w-[1158px]  flex justify-center w-[70%] smallest:w-full  bg-[color:var(--skill-tease)]  absolute mb-8 -bottom-16 tablet:-bottom-20 py-8 items-center flex-wrap z-20 gap-8 gap-y-2 animate-grow opacity-0 animation-delay-3000 shadow-2xl  " : "max-w-[1158px] flex justify-center bg-[color:var(--skill-tease-dark)] w-[70%] smallest:w-full absolute mb-8 -bottom-16 tablet:-bottom-20 py-8 items-center animate-grow flex-wrap z-20 gap-8 gap-y-2 shadow-2xl"}>
