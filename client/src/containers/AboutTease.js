  ...
  return (
    ...
    <div  className={theme==="light"? "bg-[color:var(--about-tease)]" : "bg-[color:var(--about-tease-dark)]"}>
        ...
        <div className="flex gap-12 justify-center mx-8 flex-wrap py-16">
            <div className={`${theme==="light"? "flex flex-col max-w-[410px] leading-loose hover:shadow-2xl   relative  hover:scale-105  transition-all  bg-[color:var(--about-card)] py-6 px-4  text-black " : "flex flex-col max-w-[410px] leading-loose bg-[color:var(--about-card-dark)] py-6 px-4 hover:shadow-2xl hover:scale-105  transition-all  text-white "} ${myElementIsVisible ? 'animate-jump-in animate-fill-backwards' : ''}`}>
            ...
            <div className={`${theme==="light"? "flex flex-col max-w-[410px] leading-loose bg-[color:var(--about-card)] py-6 px-4 hover:shadow-2xl  relative hover:scale-105 transition-all pt-20 text-black " : "flex flex-col max-w-[410px] leading-loose bg-[color:var(--about-card-dark)] hover:scale-105 py-6 px-4 hover:shadow-2xl  transition-all relative  pt-20 text-white "} ${myElementIsVisible ? 'animate-jump-in animate-fill-backwards animation-delay-150' : ''}`}>
            ...
            <div className={`${theme==="light"? "flex flex-col max-w-[410px] leading-loose bg-[color:var(--about-card)] py-6 px-4 hover:shadow-2xl   relative hover:scale-105 transition-all text-black " : "flex flex-col max-w-[410px] leading-loose bg-[color:var(--about-card-dark)] hover:scale-105 py-6 px-4 hover:shadow-2xl  transition-all relative text-white "} ${myElementIsVisible ? 'animate-jump-in animate-fill-backwards animation-delay-300' : ''}`}>
